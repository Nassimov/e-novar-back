...
from app.routers.admin.kp import router as admin_kp_router
from app.routers.admin.wallet import router as admin_wallet_router
...
app.include_router(admin_kp_router,         prefix="/api/admin/kp",         tags=["Admin — EP"])
app.include_router(admin_wallet_router,     prefix="/api/admin/wallet",     tags=["Admin — Wallet"])
